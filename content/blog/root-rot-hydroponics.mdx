...
faqs:
  ...
  - q: "Can I save a plant with root rot in hydroponics?"
    a: "Often yes, if caught early. Remove the plant from the system, trim all visibly infected roots with sterile scissors, rinse remaining root tissue with diluted hydrogen peroxide, then replace with fresh nutrients and treat the reservoir. Plants with more than 60–70% of their root mass infected are unlikely to recover fully. The speed of intervention determines the outcome — early detection through regular root inspection is the most important factor."
...
Root rot in hydroponics is an infection caused by Pythium species — oomycetes commonly called water moulds. [Pythium is not a true fungus but belongs to a separate biological kingdom, Stramenopila](https://www.apsnet.org/edcenter/disandpath/oomycete/pdlessons/Pages/Pythium.aspx), sharing more genetic history with brown algae than with mushrooms. This taxonomic distinction matters practically: azoxystrobin, copper-based fungicides, and most standard antifungal garden products are not effective against Pythium. Treating root rot with antifungal products is a common mistake that wastes time while the infection spreads.

Pythium exists at low levels in most water sources without causing problems. It becomes pathogenic when growing conditions shift in its favour: warm, oxygen-depleted water with stagnant areas where spores can settle onto root tissue. Once established on root surfaces, it releases enzymes that break down cell walls and spreads rapidly — an infection in one plant can reach neighbouring plants through shared reservoir water within 48 hours.
...
**1. Warm water temperature.** Pythium is directly temperature-dependent. Studies on Pythium pathogenesis in hydroponic systems consistently identify water temperature as the primary environmental driver — infection rates and spread both increase significantly above 68°F (20°C). Below 65°F, Pythium remains largely dormant even when present in the water. This explains why growers in warm climates or unventilated spaces experience root rot far more frequently than those in cooler environments.
...
**Step 2: Trim infected roots.** Using sterile scissors, cut away all roots that are brown, grey, or black. Cut back to healthy white tissue. If more than 70% of the root mass is infected, the plant is unlikely to recover — removing it prevents further contamination of the reservoir.

**Step 3: Rinse remaining healthy roots.** Prepare a diluted rinse solution of 3ml of 3% H2O2 per litre of clean water. Gently submerge the remaining root mass for five minutes. This kills Pythium spores on the root surface without damaging surviving root tissue.

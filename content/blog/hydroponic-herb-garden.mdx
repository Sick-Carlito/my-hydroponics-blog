...
faqs:
  ...
  - q: "Why are herbs the best crop for hydroponics?"
    a: "Hydroponics herbs outperform every other crop category for home growers because they combine the shortest harvest cycle (21–45 days) with the lowest light requirements, and they deliver the highest grocery savings per square foot. Unlike fruiting crops, herb hydroponics doesn't require high-output LEDs, large containers, or pollination. A few mason jars on a windowsill is enough to run a productive system year-round."
...
The Kratky method uses a mason jar, net pot, clay pebbles, and nutrient solution. No pump, no electricity, no moving parts. [The Kratky method is ideal for beginners and small-scale herb growers](https://blogs.ifas.ufl.edu/stlucieco/2025/04/17/kratky-hydroponic-method-a-simple-way-to-grow-plants-without-soil/) because it eliminates equipment failure and electricity dependency entirely, according to UF/IFAS Extension. Set up 4–6 jars on a sunny windowsill and you have a complete indoor herb garden at home for under $50. It's the simplest possible entry point for growing hydroponic herbs indoors.

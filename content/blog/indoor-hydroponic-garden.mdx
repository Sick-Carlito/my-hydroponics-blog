...
Indoors, **LED grow lights** replace sunlight and provide the full spectrum plants need for photosynthesis. Most food crops need 12–16 hours of light per day. The result is a closed, controlled system: you manage the water, [nutrients](/blog/hydroponic-nutrients), light, and [pH](/blog/ph-for-hydroponics). Roots don't have to search through soil for what they need — everything is delivered directly.
...
The Kratky method is a passive, no-pump system where the plant feeds itself from a sealed reservoir of nutrient water as it grows — described by UF/IFAS Extension as a ["set-it-and-forget-it" approach](https://blogs.ifas.ufl.edu/stlucieco/2025/04/17/kratky-hydroponic-method-a-simple-way-to-grow-plants-without-soil/) requiring no electricity or prior experience.

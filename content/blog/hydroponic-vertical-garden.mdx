...
takeaways:
  ...
  - "Hydroponic systems use [up to 95% less water](https://pmc.ncbi.nlm.nih.gov/articles/PMC4483736/) than soil growing. Vertical setups amplify this by keeping the reservoir compact and minimizing evaporation."
...
faqs:
  - q: "What is a hydroponic vertical garden?"
    a: "A hydroponic vertical garden is a soil-free growing system that arranges plants in a vertical column, wall panel, or stacked configuration rather than in horizontal rows. Nutrient solution is delivered via pump or gravity to plant roots held in net pots or growing channels. It's designed for people who want to maximize yield in limited floor space, like apartments, balconies, small patios, and indoor setups."
...
On water: a [PMC analysis](https://pmc.ncbi.nlm.nih.gov/articles/PMC4483736/) found hydroponic systems use up to **95% less water** than soil for the same crop. Vertical setups amplify this. The reservoir is compact, the loop is closed, and almost nothing evaporates.

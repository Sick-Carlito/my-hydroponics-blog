...
A **DIY hydroponic garden** can be built for as little as $10 with a mason jar, or up to $150 for a PVC rail growing a dozen plants at once. The right build depends on your budget, crops, and time.
...
Once you want to grow 6–12 plants at once, single jars and individual buckets become impractical. The two best scale-up builds are the **storage tote DWC** and the **PVC NFT rail** — both at a similar price point, with different trade-offs depending on your space and how comfortable you are with PVC work.

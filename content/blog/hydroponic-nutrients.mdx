...
faqs:
  - q: "What nutrients do hydroponic plants need?"
    a: "Hydroponic plants need the same 17 essential elements as soil-grown plants. That includes nitrogen (N), phosphorus (P), potassium (K), calcium, magnesium, sulfur, and 11 trace minerals such as iron, manganese, zinc, and copper. Since there is no soil to supply any of these, every element must be dissolved into the water at the correct concentration and pH before roots can absorb it."
  - q: "What is the best hydroponic nutrient solution for beginners?"
    a: "For pure simplicity, General Hydroponics MaxiGro is the easiest starting point. It's one powder dissolved in water with no multi-part ratios. For the lowest long-term cost, Jack's 321 or Masterblend 4-18-38 deliver comparable results at roughly $0.02–$0.07 per gallon once you learn the three-part mixing process. For stage-specific control on fruiting crops, the Flora Series 3-part liquid system is the industry standard."
  - q: "How often should I change hydroponic nutrients?"
    a: "Change your full reservoir every 7–14 days for most systems. Between changes, top up with plain pH-adjusted water as the level drops. If your EC rises significantly between top-ups, that means plants are consuming more water than nutrients, and you should do a full change sooner. If EC is dropping faster than expected, your plants are feeding heavily and may need more concentrated solution."
  - q: "Can I use regular fertilizer for hydroponics?"
    a: "No. Standard soil fertilizers are not designed for hydroponics. They often contain nutrients in forms that don't dissolve properly in water, and they lack the complete micronutrient profile plants need when grown without soil. Soil fertilizers also typically contain slow-release coatings that don't function in water. Use nutrients specifically formulated for hydroponic use."
  - q: "What is EC in hydroponics?"
    a: "EC stands for electrical conductivity. It measures how many dissolved nutrients are in your water by how well the solution conducts electricity. Higher EC means more nutrients. Most beginner crops need an EC of 0.8–2.0 depending on growth stage and crop type. You measure EC with an inexpensive pen meter, and the reading tells you when to add more nutrients or dilute the solution with plain water."
  - q: "What is the difference between EC and PPM in hydroponics?"
    a: "Both measure nutrient concentration. EC is a universal measurement in millisiemens (mS/cm). PPM (parts per million) is derived from EC by multiplying by a conversion factor. The two most common factors are the 500 scale (EC x 500 = PPM) and the 700 scale (EC x 700 = PPM). Check which scale your meter uses (the manual will specify) and stick with it consistently so your readings are comparable over time."
...
<p style="text-align:center;font-size:0.8125rem;color:#9ca3af;font-style:italic;margin-top:0.25rem;margin-bottom:2.5rem;">Target EC ranges for common hydroponic crops, from seedlings through fruiting, with practical notes on where in each range to sit.</p>

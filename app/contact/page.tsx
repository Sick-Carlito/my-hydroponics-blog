      ...
      <section className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-vegetation-50 to-lime-50/60 rounded-2xl border border-vegetation-100 p-8">
            <h2 className="text-xl font-bold text-gray-900 mb-4">What I want to hear</h2>
            <ul className="space-y-3 text-gray-700 text-sm">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <strong className="text-gray-900">Errors and outdated information</strong> — if a price is wrong, a link is broken, or a fact doesn&apos;t hold up, please tell me. I&apos;d rather fix it than leave it.
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  <strong className="text-gray-900">Better sources</strong> — if you know of a peer-reviewed study or university extension resource I missed, I want to see it.
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  <strong className="text-gray-900">Topic requests</strong> — if there&apos;s a hydroponic question you can&apos;t find a good answer to, that&apos;s a guide I should probably write.
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  <strong className="text-gray-900">General questions</strong> — I&apos;m not a growing expert, but I&apos;m happy to point you toward the right resources.
                </div>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center">
            <h2 className="text-xl font-bold text-gray-900 mb-2">Want weekly tips instead?</h2>
            <p className="text-gray-500 text-sm mb-5">One curated hydroponic tip every week. Free, no spam.</p>
            <Link
              href="/blog#newsletter"
              className="inline-flex items-center gap-2 px-6 py-3 border-2 border-vegetation-600 text-vegetation-600 font-bold rounded-xl hover:bg-vegetation-600 hover:text-white transition-all"
            >
          ...
          <div className="text-center pt-2">
            <Link href="/" className="text-vegetation-600 hover:text-vegetation-700 font-semibold text-sm transition-colors">

      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20">
        ...
        <div className="space-y-8 text-gray-700 leading-relaxed">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-5">
            <h2 className="text-xl font-bold text-gray-900">What we collect and why</h2>

            <div>
              <h3 className="font-bold text-gray-900 mb-1">Newsletter subscriptions</h3>
              <p className="text-sm">
            ...
            <div>
              <h3 className="font-bold text-gray-900 mb-1">Affiliate links</h3>
              <p className="text-sm">
            ...
            <div>
              <h3 className="font-bold text-gray-900 mb-1">No cookies beyond analytics</h3>
              <p className="text-sm">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            <ul className="space-y-2 text-sm">
              <li><strong>EmailOctopus</strong> — stores and sends the newsletter. Their privacy policy applies to how they handle your email address.</li>
              <li><strong>Google Analytics / Tag Manager</strong> — anonymous site traffic data.</li>
              <li><strong>Vercel</strong> — hosts this website. Standard server logs (IP address, browser, page requested) are retained per Vercel&apos;s data retention policy.</li>
            </ul>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            <p className="text-sm">
              ...
              <a href="mailto:hello@hydroponicscentral.com" className="text-vegetation-600 hover:underline font-medium">

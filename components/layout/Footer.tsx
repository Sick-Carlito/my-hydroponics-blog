...
export const Footer: React.FC = () => {
  ...
  const socialLinks = [
    {
      name: 'Twitter',
      href: 'https://twitter.com/hydroponicscentral',
      icon: (
    ...
    {
      name: 'Facebook',
      href: 'https://facebook.com/hydroponicscentral',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Instagram',
      href: 'https://instagram.com/hydroponicscentral',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Pinterest',
      href: 'https://pinterest.com/hydroponicscentral',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">

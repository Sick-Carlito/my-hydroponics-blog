  ...
  return (
    <div className='min-h-screen bg-white'>
      <style>{`
        ...
        .blog-pros-box{flex:1;min-width:240px;padding:24px;border-radius:16px;background-color:#f0fdf4;border:2px solid #86efac}
        .blog-cons-box{flex:1;min-width:240px;padding:24px;border-radius:16px;background-color:#fff5f5;border:2px solid #fca5a5}
        ...
        .blog-box-li{display:flex;align-items:flex-start;gap:10px;font-size:15px;line-height:1.7;color:#374151;margin-bottom:8px}
        .blog-box-check{flex-shrink:0;color:#16a34a;font-size:16px;font-weight:900;margin-top:1px}
        .blog-box-cross{flex-shrink:0;color:#dc2626;font-size:16px;font-weight:900;margin-top:1px}
      `}</style>
      {/* Progress bar */}
